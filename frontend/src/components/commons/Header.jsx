            ...
            <div className="header-layout-4">
               <div className="header-to-main d-none d-sm-flex">
                  ...
                  <div className="header-top-notice d-none d-lg-block">
                     <p>TAKE CARE OF YOUR Health <span className="text-white">25% OFF</span> USE CODE “ DOFIX03 ”</p>
                  </div>
                  <div className="tp-header-top-menu d-flex align-items-center justify-content-end">
                     <div className="header-lang-item header-lang">
                        <span className="header-lang-toggle text-white" id="header-lang-toggle">English</span>
                        <ul className="">
                           <li>
                              <a className="furniture-clr-hover" href="#">Spanish</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">Russian</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">Portuguese</a>
                           </li>
                        </ul>
                     </div>
                     <div className="header-lang-item tp-header-currency">
                        ...
                        <ul>
                           <li>
                              <a className="furniture-clr-hover" href="#">EUR</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">CHF</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">GBP</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">KWD</a>
                           </li>
                        </ul>
                     </div>
                     <div className="header-lang-item tp-header-setting">
                        ...
                        <ul>
                           <li>
                              <a className="furniture-clr-hover" href="#">My Profile</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="wishlist.html">Wishlist</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="cart.html">Cart</a>
                           </li>
                           <li>
                              <a className="furniture-clr-hover" href="#">Logout</a>
                           </li>
                        </ul>
                     </div>
                  </div>
